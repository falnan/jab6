...
import { index as sendersIndex, store } from '@/routes/senders';

type CreateSenderForm = {
    code: string;
    name: string;
};

export default function CreateSender() {
    const form = useForm<CreateSenderForm>({
        code: '',
        name: '',
    });
    ...
    const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
        ...
        form.post(store().url, {
            preserveScroll: true,
            onSuccess: () => {
                toast.success('Ekspedisi berhasil dibuat', {
                    position: 'top-right',
                    style: {
                        borderRadius: '8px',
                        background: '#ffffff',
            ...
            onError: () => {
                toast.error('Gagal membuat ekspedisi', {
                    position: 'top-right',
                    style: {
                        borderRadius: '8px',
                        background: '#ffffff',
